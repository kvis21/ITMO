...
# Импортируем наши модули транслятора
...
def cmd_run(args):
    """Логика команды run (заготовка для эмулятора)."""
    binary_name = args.binary_name
    memory_name = args.memory_name
    input_tokens = args.input
    
    print(f"[*] Запуск эмулятора...")
    print(f"    IMEM: {binary_name}")
    print(f"    DMEM: {memory_name}")
    if input_tokens:
        print(f"    Ввод: {input_tokens}")
        
    print("[!] Эмулятор (machine.py) еще не реализован.")
...
def main():
    ...
    parser_translate.add_argument('binary_name', help="Выходной бинарный файл инструкций (IMEM)")
    parser_translate.add_argument('memory_name', help="Выходной бинарный файл памяти (DMEM)")
    ...
    parser_run.add_argument('binary_name', help="Бинарный файл инструкций (IMEM)")
    parser_run.add_argument('memory_name', help="Бинарный файл памяти (DMEM)")
